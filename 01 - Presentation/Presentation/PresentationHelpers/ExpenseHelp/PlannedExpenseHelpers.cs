    ...
    public class PlannedExpenseHelpers
    {
        ...
        public async Task CreatePlannedExpenseAsync()
        {
            ...
            do
            {
                ...
                create = _input.GetBool("Would you like to create another planned expense? (y/n): ");
            } while (create);
        }
        ...
        public async Task UpdatePlannedExpenseAsync()
        {
            ...
            do
            {
                ...
                update = _input.GetBool("Would you like to update another planned expense? (y/n): ");
            } while (update);
        }
        ...
        public async Task DeletePlannedExpenseAsync()
        {
            ...
            do
            {
                ...
                delete = _input.GetBool("Would you like to delete another planned expense? (y/n): ");
            } while (delete);
        }
    }
}
